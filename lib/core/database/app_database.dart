...
import 'package:party_games_app/features/tasks/data/data_sources/local/DAO/choice_task_dao.dart';
...
@UseMoor(tables: [LocalGames, BaseTasks, CheckedTextTasks, TaskBindings, PollTasks, ChoiceTaskOptions], daos: [GameDao, TaskBindingDao, BaseTaskDao, CheckedTextTaskDao, PollTaskDao, ChoiceTaskDao])
