...
class CheckedTextTaskModel extends TaskModel{
  ...
  factory CheckedTextTaskModel.fromTables(LocalBaseTask baseTask, LocalCheckedTextTask checkedTextTask){
    return CheckedTextTaskModel(
      id: baseTask.id,
      name: baseTask.name,
  ...
  Insertable<LocalCheckedTextTask> toInsertable({int? baseId}){
    return CheckedTextTasksCompanion(
      baseTaskId: baseId != null ? Value(baseId) : (id != null ? Value(id!) : Value.absent()),
